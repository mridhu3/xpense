...
const firebaseConfig = {
  apiKey: process.env.EXPO_PUBLIC_FIREBASE_API_KEY ?? "AIzaSyDIWX4oB5tJ0ETMu-osgx4rknD9xCHpZRk",
  authDomain: process.env.EXPO_PUBLIC_FIREBASE_AUTH_DOMAIN ?? "xpense-8451c.firebaseapp.com",
  projectId: process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID ?? "xpense-8451c",
  storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET ?? "xpense-8451c.firebasestorage.app",
  messagingSenderId: process.env.EXPO_PUBLIC_FIREBASE_MESSAGING_SENDER_ID ?? "628537368841",
  appId: process.env.EXPO_PUBLIC_FIREBASE_APP_ID ?? "1:628537368841:android:4ddcab699a73772614b3d8",
};
